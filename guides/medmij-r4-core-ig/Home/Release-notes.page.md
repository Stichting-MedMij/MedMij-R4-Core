...
| Dataset                     | Logical Models corresponding to the ASAScore and HealthProfessional information models have been added. | [DOSINZAGE1-879](https://medmij.atlassian.net/browse/DOSINZAGE1-879) |
| FHIR artifacts              | The profile medmij-core-ASAScore has been created and added to the IG. | [DOSINZAGE1-879](https://medmij.atlassian.net/browse/DOSINZAGE1-879) |
