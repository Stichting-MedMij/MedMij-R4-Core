...
| **Must Support** | <ul> <li> `.identifier` <li> `.name` <li> `.birthDate` <li> `.contact` <li> `.generalPractitioner` <li> `.meta.tag` (only the {{pagelink: GranularExchange, text: care type, anchor: CareType}}) |
