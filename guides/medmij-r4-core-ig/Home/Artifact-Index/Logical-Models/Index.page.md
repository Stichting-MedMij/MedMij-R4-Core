...
- For all Logical Models (with the exception of the HealthProfessional Logical Model) the scope is implicitly set to a single patient. This relation is not explicitly modeled, similar to the approach of the [zibs](https://zibs.nl/wiki/HCIM_Release_2020(EN)).
