...
* rest
  * mode = #client
  * documentation = "Minimal requirements for a client to fulfill the 'Retrieve ASA score' transaction (system role: MMC-ASR-rc.3)."
  * resource[+]
    * type = #Observation
...
* rest
  * mode = #server
  * documentation = "Minimal requirements for a server to fulfill the 'Serve ASA score' transaction (system role: MMC-ASB-rc.3)."
  * resource[+]
    * type = #Observation
    * supportedProfile = "http://medmij.nl/fhir/StructureDefinition/medmij-core-ASAScore"
    * interaction
