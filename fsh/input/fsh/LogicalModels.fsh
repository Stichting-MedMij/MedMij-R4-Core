...
* HealthcareProvider -> "medmij-core-dataelement-43" "HealthcareProvider"
  * HealthcareProviderIdentificationNumber -> "medmij-core-dataelement-44" "HealthcareProviderIdentificationNumber"
  * OrganizationName -> "medmij-core-dataelement-45" "OrganizationName"
  * DepartmentSpecialty -> "medmij-core-dataelement-46" "DepartmentSpecialty"
  * ContactInformation -> "medmij-core-dataelement-47" "ContactInformation"
    * TelephoneNumbers -> "medmij-core-dataelement-48" "TelephoneNumbers"
      * TelephoneNumber -> "medmij-core-dataelement-49" "TelephoneNumber"
      * TelecomType -> "medmij-core-dataelement-50" "TelecomType"
      * NumberType -> "medmij-core-dataelement-51" "NumberType"
      * Comment -> "medmij-core-dataelement-52" "Comment"
    * EmailAddresses -> "medmij-core-dataelement-53" "EmailAddresses"
      * EmailAddress -> "medmij-core-dataelement-54" "EmailAddress"
      * EmailAddressType -> "medmij-core-dataelement-55" "EmailAddressType"
  * AddressInformation -> "medmij-core-dataelement-56" "AddressInformation"
    * Street -> "medmij-core-dataelement-57" "Street"
    * HouseNumber -> "medmij-core-dataelement-58" "HouseNumber"
    * HouseNumberLetter -> "medmij-core-dataelement-59" "HouseNumberLetter"
    * HouseNumberAddition -> "medmij-core-dataelement-60" "HouseNumberAddition"
    * HouseNumberIndication -> "medmij-core-dataelement-61" "HouseNumberIndication"
    * Postcode -> "medmij-core-dataelement-62" "Postcode"
    * PlaceOfResidence -> "medmij-core-dataelement-63" "PlaceOfResidence"
    * Municipality -> "medmij-core-dataelement-64" "Municipality"
    * Country -> "medmij-core-dataelement-65" "Country"
    * AdditionalInformation -> "medmij-core-dataelement-66" "AdditionalInformation"
    * AddressType -> "medmij-core-dataelement-67" "AddressType"
  * OrganizationType -> "medmij-core-dataelement-68" "OrganizationType"
  * OrganizationLocation -> "medmij-core-dataelement-69" "OrganizationLocation"
    * LocationName -> "medmij-core-dataelement-70" "LocationName"
    * LocationNumber -> "medmij-core-dataelement-71" "LocationNumber"
